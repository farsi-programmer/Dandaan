...
namespace Dandaan.Forms
{
    ...
    {
        protected Func<DataGridViewRow[]> ArrayFunc;
        ...
        protected override void Act()
        {
            ...
            ArrayFunc = () => { return x.Skip((Page - 1) * PageSize).Take(PageSize).Select((k) => { Invoke(new Action(() => { k.Cells[0].Value = (int)k.Cells[0].Value + DateTime.Now.Second; })); return k; }).ToArray(); };
